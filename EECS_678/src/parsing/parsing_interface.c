...
IMPLEMENT_DEQUE_MEMORY_POOL(Cmds, Cmd_Holder);
...
static void __stringify_holder(Cmd_Holder holder, CmdStrs* strs) {
...
static void __stringify_script(const Cmd_Holder* holders, CmdStrs* strs) {
  assert(holders != NULL);
  assert(strs != NULL);
